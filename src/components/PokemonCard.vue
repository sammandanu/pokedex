...
<template>
  <div
    ...
    :style="stroreTypes[data.types[0].type.name as keyof typeof stroreTypes].color"
    @click="toDetails(data.name)"
  >
    <!-- image -->
    ...
    <!-- favorite -->
    <div
      class="absolute right-0 top-0 pt-4 pr-4 z-10"
      @click.stop="checkFavorite(data)"
    >
      <div class="w-8 h-8 rounded-md bg-black bg-opacity-20 p-1.5">
        <svg
          viewBox="0 0 24 24"
          :fill="data.favorite ? '#F25781' : 'none'"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M12.62 20.81C12.28 20.93 11.72 20.93 11.38 20.81C8.48 19.82 2 15.69 2 8.68998C2 5.59998 4.49 3.09998 7.56 3.09998C9.38 3.09998 10.99 3.97998 12 5.33998C13.01 3.97998 14.63 3.09998 16.44 3.09998C19.51 3.09998 22 5.59998 22 8.68998C22 15.69 15.52 19.82 12.62 20.81Z"
            :stroke="data.favorite ? '#F25781' : '#fff'"
            stroke-width="1.5"
